...
public class Source2Target {
  ...
  public boolean execute(final Transformation transformation) {
    ...
    // Semantic Object: PackageDeclaration'org.eclipse.jqvt.examples.shapes.r9'.transformation->Transformation.rules[4]->Relation'Source2Target'.when[0]->XBinaryOperation
    // Context: XExpression
    if (!evaluateClause2()) {trafo.logFailure(101);
    return false;
    }trafo.logSuccess(101);
    // t : ModelElement {..}
