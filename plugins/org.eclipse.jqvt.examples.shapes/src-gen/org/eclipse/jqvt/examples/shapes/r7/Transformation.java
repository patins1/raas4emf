...
import org.eclipse.jqvt.examples.shapes.r7.ArrowSource2ArrowSource;
import org.eclipse.jqvt.examples.shapes.r7.ArrowTarget2ArrowTarget;
import org.eclipse.jqvt.examples.shapes.r7.MapArrow;
import org.eclipse.jqvt.examples.shapes.r7.MapBlock;
import org.eclipse.jqvt.examples.shapes.r7.MapCircle;
import org.eclipse.jqvt.examples.shapes.r7.MapRootBlock;
import org.eclipse.jqvt.examples.shapes.r7.MapSquare;
import org.eclipse.jqvt.examples.shapes.r7.MapTriangle;
import org.eclipse.jqvt.examples.shapes.r7.ModelElementName2ModelElementName;
import org.eclipse.jqvt.examples.shapes.r7.ModelElementblock2ModelElementblock;
...
public abstract class Transformation {
  ...
  public boolean createSquareForInitialArrow(final Object s, final Object t) {
    throw new RuntimeException("should never be called");
  }
  
  public boolean createSquareForFinalArrow(final Object s, final Object t) {
    throw new RuntimeException("should never be called");
  }
  ...
  public HashMap<createSquareForInitialArrow,createSquareForInitialArrow> traces_createSquareForInitialArrow;
  
  public createSquareForInitialArrow push_relation_createSquareForInitialArrow(final Circle s, final Square t) {
    createSquareForInitialArrow result = new createSquareForInitialArrow(s);
    if (traces_createSquareForInitialArrow==null) traces_createSquareForInitialArrow = new java.util.HashMap<createSquareForInitialArrow,createSquareForInitialArrow>();
    if (traces_createSquareForInitialArrow.containsKey(result)) {
    	result = traces_createSquareForInitialArrow.get(result);
    } else {
    	traces_createSquareForInitialArrow.put(result,null);
    	result.t = t;
    	this.relStack.push(result);
    	boolean execResult = result.execute(this);
    	this.relStack.pop();
    	if (!execResult) return null;
    	traces_createSquareForInitialArrow.put(result,result);
  ...
  public createSquareForInitialArrow relation_createSquareForInitialArrow(final Circle s) {
    createSquareForInitialArrow result = new createSquareForInitialArrow(s);
    if (traces_createSquareForInitialArrow==null) traces_createSquareForInitialArrow = new java.util.HashMap<createSquareForInitialArrow,createSquareForInitialArrow>();
    if (traces_createSquareForInitialArrow.containsKey(result)) {
    	result = traces_createSquareForInitialArrow.get(result);
  ...
  public HashMap<createSquareForFinalArrow,createSquareForFinalArrow> traces_createSquareForFinalArrow;
  
  public createSquareForFinalArrow push_relation_createSquareForFinalArrow(final Circle s, final Square t) {
    createSquareForFinalArrow result = new createSquareForFinalArrow(s);
    if (traces_createSquareForFinalArrow==null) traces_createSquareForFinalArrow = new java.util.HashMap<createSquareForFinalArrow,createSquareForFinalArrow>();
    if (traces_createSquareForFinalArrow.containsKey(result)) {
    	result = traces_createSquareForFinalArrow.get(result);
    } else {
    	traces_createSquareForFinalArrow.put(result,null);
    	result.t = t;
    	this.relStack.push(result);
    	boolean execResult = result.execute(this);
    	this.relStack.pop();
    	if (!execResult) return null;
    	traces_createSquareForFinalArrow.put(result,result);
  ...
  public createSquareForFinalArrow relation_createSquareForFinalArrow(final Circle s) {
    createSquareForFinalArrow result = new createSquareForFinalArrow(s);
    if (traces_createSquareForFinalArrow==null) traces_createSquareForFinalArrow = new java.util.HashMap<createSquareForFinalArrow,createSquareForFinalArrow>();
    if (traces_createSquareForFinalArrow.containsKey(result)) {
    	result = traces_createSquareForFinalArrow.get(result);
  ...
  public List<String> topOrder = java.util.Arrays.asList( "ArrowSource2ArrowSource", "ArrowTarget2ArrowTarget", "ModelElementName2ModelElementName", "ModelElementblock2ModelElementblock", "Source2Target", "MapRootBlock", "MapBlock", "MapCircle", "MapTriangle", "MapSquare", "MapArrow" );
