...
import org.eclipse.jqvt.examples.shapes.r1_incarnation_by_where.ArrowSource2ArrowSource;
import org.eclipse.jqvt.examples.shapes.r1_incarnation_by_where.ArrowTarget2ArrowTarget;
...
import org.eclipse.jqvt.examples.shapes.r1_incarnation_by_where.ModelElementName2ModelElementName;
import org.eclipse.jqvt.examples.shapes.r1_incarnation_by_where.ModelElementblock2ModelElementblock;
import org.eclipse.jqvt.examples.shapes.r1_incarnation_by_where.Source2Target;
...
public abstract class Transformation {
  ...
  public MapRootBlock push_relation_MapRootBlock(final RootBlock s, final RootBlock t) {
  ...
  public MapRootBlock relation_MapRootBlock(final RootBlock s) {
    MapRootBlock result = new MapRootBlock(s);
    if (traces_MapRootBlock==null) traces_MapRootBlock = new java.util.HashMap<MapRootBlock,MapRootBlock>();
    if (traces_MapRootBlock.containsKey(result)) {
    	result = traces_MapRootBlock.get(result);
  ...
  public MapBlock push_relation_MapBlock(final Block s, final Block t) {
  ...
  public MapBlock relation_MapBlock(final Block s) {
    MapBlock result = new MapBlock(s);
    if (traces_MapBlock==null) traces_MapBlock = new java.util.HashMap<MapBlock,MapBlock>();
    if (traces_MapBlock.containsKey(result)) {
    	result = traces_MapBlock.get(result);
  ...
  public MapCircle push_relation_MapCircle(final Circle s, final Square t) {
  ...
  public MapCircle relation_MapCircle(final Circle s) {
    MapCircle result = new MapCircle(s);
    if (traces_MapCircle==null) traces_MapCircle = new java.util.HashMap<MapCircle,MapCircle>();
    if (traces_MapCircle.containsKey(result)) {
    	result = traces_MapCircle.get(result);
  ...
  public MapTriangle push_relation_MapTriangle(final Triangle s, final Triangle t) {
  ...
  public MapTriangle relation_MapTriangle(final Triangle s) {
    MapTriangle result = new MapTriangle(s);
    if (traces_MapTriangle==null) traces_MapTriangle = new java.util.HashMap<MapTriangle,MapTriangle>();
    if (traces_MapTriangle.containsKey(result)) {
    	result = traces_MapTriangle.get(result);
  ...
  public MapSquare push_relation_MapSquare(final Square s, final Square t) {
  ...
  public MapSquare relation_MapSquare(final Square s) {
    MapSquare result = new MapSquare(s);
    if (traces_MapSquare==null) traces_MapSquare = new java.util.HashMap<MapSquare,MapSquare>();
    if (traces_MapSquare.containsKey(result)) {
    	result = traces_MapSquare.get(result);
  ...
  public MapArrow push_relation_MapArrow(final Arrow s, final Arrow t) {
  ...
  public MapArrow relation_MapArrow(final Arrow s) {
    MapArrow result = new MapArrow(s);
    if (traces_MapArrow==null) traces_MapArrow = new java.util.HashMap<MapArrow,MapArrow>();
    if (traces_MapArrow.containsKey(result)) {
    	result = traces_MapArrow.get(result);
  ...
  public List<String> topOrder = java.util.Arrays.asList( "ArrowSource2ArrowSource", "ArrowTarget2ArrowTarget", "ModelElementName2ModelElementName", "ModelElementblock2ModelElementblock", "Source2Target" );
