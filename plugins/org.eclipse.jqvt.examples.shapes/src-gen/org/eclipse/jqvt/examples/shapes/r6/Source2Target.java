...
public class Source2Target {
  ...
  public boolean evaluateClause2() {
    ...
    if (_MapBlock) {
      ...
      boolean _MapBlockAsShape = false;
      MapBlockAsShape _MapBlockAsShape_tuple;
      if (this.s instanceof Block && 
          (_MapBlockAsShape_tuple = trafo.top_relation_MapBlockAsShape((Block)this.s)) != null)
      {
        t =  _MapBlockAsShape_tuple.t;
        _MapBlockAsShape = true;
      }
      _or_5 = (_MapBlock || _MapBlockAsShape);
    }
    if (_or_5) {
      _or_4 = true;
    } else {
  ...
  public boolean execute(final Transformation transformation) {
    ...
    // Semantic Object: PackageDeclaration'org.eclipse.jqvt.examples.shapes.r6'.transformation->Transformation.rules[4]->Relation'Source2Target'.when[0]->XBinaryOperation
    // Context: XExpression
