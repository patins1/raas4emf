...
public class Source2Target {
  ...
  public boolean execute(final Transformation transformation) {
    ...
    // Semantic Object: PackageDeclaration'org.eclipse.jqvt.examples.shapes.copy'.transformation->Transformation.rules[4]->Relation'Source2Target'.when[0]->XBinaryOperation
    // Context: XExpression
    if (!evaluateClause2()) {trafo.logFailure(92);
    return false;
    }trafo.logSuccess(92);
    // t : ModelElement {..}
