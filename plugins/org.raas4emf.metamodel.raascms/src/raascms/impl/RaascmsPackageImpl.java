 ...
 * @generated
 */
public class RaascmsPackageImpl extends EPackageImpl implements RaascmsPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see raascms.RaascmsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private RaascmsPackageImpl() {
		super(eNS_URI, RaascmsFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link RaascmsPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static RaascmsPackage init() {
		if (isInited) return (RaascmsPackage)EPackage.Registry.INSTANCE.getEPackage(RaascmsPackage.eNS_URI);

		// Obtain or create and register package
		RaascmsPackageImpl theRaascmsPackage = (RaascmsPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof RaascmsPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new RaascmsPackageImpl());
		...
		theRaascmsPackage.createPackageContents();

		// Initialize created meta-data
		theRaascmsPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theRaascmsPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(RaascmsPackage.eNS_URI, theRaascmsPackage);
		return theRaascmsPackage;
	}
	 ...
	 * @generated
	 */
	public EReference getFolder_Artifacts() {
	 ...
	 * @generated
	 */
	public EAttribute getArtifact_FileContent() {
	 ...
	 * @generated
	 */
	public EReference getArtifact_DependentArtifact() {
	 ...
	 * @generated
	 */
	public EAttribute getArtifact_ModelDate() {
	 ...
	 * @generated
	 */
	public EAttribute getArtifact_BlobDate() {
	...
	public void createPackageContents() {
		...
		createEReference(folderEClass, FOLDER__ARTIFACTS);
		createEReference(folderEClass, FOLDER__FOLDERS);

		artifactEClass = createEClass(ARTIFACT);
		createEAttribute(artifactEClass, ARTIFACT__FILE_CONTENT);
		createEReference(artifactEClass, ARTIFACT__CONTENTS);
		createEAttribute(artifactEClass, ARTIFACT__STATE);
		createEReference(artifactEClass, ARTIFACT__DEPENDENT_ARTIFACT);
	...
	public void initializePackageContents() {
		...
		initEReference(getFolder_Artifacts(), this.getArtifact(), null, "artifacts", null, 0, -1, Folder.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getArtifact_FileContent(), theEtypesPackage.getBlob(), "fileContent", null, 0, 1, Artifact.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getArtifact_Contents(), theEcorePackage.getEObject(), null, "contents", null, 0, -1, Artifact.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getArtifact_State(), theEcorePackage.getEString(), "state", null, 0, 1, Artifact.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getArtifact_DependentArtifact(), this.getArtifact(), null, "dependentArtifact", null, 0, 1, Artifact.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
