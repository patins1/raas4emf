...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Top Class B</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link au.com.smartservicescrc.raas_small_test.impl.TopClassBImpl#getRaasRef <em>Raas Ref</em>}</li>
 *   <li>{@link au.com.smartservicescrc.raas_small_test.impl.TopClassBImpl#getMulti2lowerAttrInt <em>Multi2lower Attr Int</em>}</li>
 *   <li>{@link au.com.smartservicescrc.raas_small_test.impl.TopClassBImpl#getSingleAttrInt <em>Single Attr Int</em>}</li>
 *   <li>{@link au.com.smartservicescrc.raas_small_test.impl.TopClassBImpl#getOptionalAttrInt <em>Optional Attr Int</em>}</li>
 *   <li>{@link au.com.smartservicescrc.raas_small_test.impl.TopClassBImpl#getMultiRefClassE <em>Multi Ref Class E</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
@XmlRootElement(name = "TopClassBElement")
@XmlType(name = "TopClassB")
public class TopClassBImpl extends EObjectImpl implements TopClassB {
	/**
	...
	/**
	 * The cached value of the '{@link #getMultiRefClassE() <em>Multi Ref Class E</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getMultiRefClassE()
	 * @generated
	 * @ordered
	 */
	protected EList<UnderClassE> multiRefClassE;
	...
	protected EClass eStaticClass() {
		return RstPackage.Literals.TOP_CLASS_B;
	}
	...
	public void setRaasRef(String newRaasRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RstPackage.TOP_CLASS_B__RAAS_REF, oldRaasRef, raasRef));
	}
	...
	public EList<Integer> getMulti2lowerAttrInt() {
		if (multi2lowerAttrInt == null) {
			multi2lowerAttrInt = new EDataTypeUniqueEList<Integer>(Integer.class, this, RstPackage.TOP_CLASS_B__MULTI2LOWER_ATTR_INT);
		}
	...
	public void setSingleAttrInt(int newSingleAttrInt) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RstPackage.TOP_CLASS_B__SINGLE_ATTR_INT, oldSingleAttrInt, singleAttrInt));
	}
	...
	public void setOptionalAttrInt(int newOptionalAttrInt) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RstPackage.TOP_CLASS_B__OPTIONAL_ATTR_INT, oldOptionalAttrInt, optionalAttrInt));
	}
	...
	public EList<UnderClassE> getMultiRefClassE() {
		if (multiRefClassE == null) {
			multiRefClassE = new EObjectResolvingEList<UnderClassE>(UnderClassE.class, this, RstPackage.TOP_CLASS_B__MULTI_REF_CLASS_E);
		}
		return multiRefClassE;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RstPackage.TOP_CLASS_B__RAAS_REF:
				return getRaasRef();
			case RstPackage.TOP_CLASS_B__MULTI2LOWER_ATTR_INT:
				return getMulti2lowerAttrInt();
			case RstPackage.TOP_CLASS_B__SINGLE_ATTR_INT:
				return getSingleAttrInt();
			case RstPackage.TOP_CLASS_B__OPTIONAL_ATTR_INT:
				return getOptionalAttrInt();
			case RstPackage.TOP_CLASS_B__MULTI_REF_CLASS_E:
				return getMultiRefClassE();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case RstPackage.TOP_CLASS_B__OPTIONAL_ATTR_INT:
				...
				return;
			case RstPackage.TOP_CLASS_B__MULTI_REF_CLASS_E:
				getMultiRefClassE().clear();
				getMultiRefClassE().addAll((Collection<? extends UnderClassE>)newValue);
				return;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case RstPackage.TOP_CLASS_B__MULTI_REF_CLASS_E:
				return multiRefClassE != null && !multiRefClassE.isEmpty();
		}
