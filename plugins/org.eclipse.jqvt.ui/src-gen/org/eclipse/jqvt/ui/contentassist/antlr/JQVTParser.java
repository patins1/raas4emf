...
public class JQVTParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.eclipse.jqvt.ui.contentassist.antlr.internal.InternalJQVTParser createParser() {
		org.eclipse.jqvt.ui.contentassist.antlr.internal.InternalJQVTParser result = new org.eclipse.jqvt.ui.contentassist.antlr.internal.InternalJQVTParser(null);
	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getTransformationAccess().getAlternatives_7(), "rule__Transformation__Alternatives_7");
					put(grammarAccess.getObjectTemplateAccess().getAlternatives_5_1(), "rule__ObjectTemplate__Alternatives_5_1");
					put(grammarAccess.getPropertyTemplateItemAccess().getValueAlternatives_2_0(), "rule__PropertyTemplateItem__ValueAlternatives_2_0");
					put(grammarAccess.getQualifiedNameAccess().getAlternatives_1_0_0(), "rule__QualifiedName__Alternatives_1_0_0");
					...
					put(grammarAccess.getQualifiedNameWithWildCard2Access().getGroup(), "rule__QualifiedNameWithWildCard2__Group__0");
					put(grammarAccess.getQualifiedNameWithWildCard2Access().getGroup_1(), "rule__QualifiedNameWithWildCard2__Group_1__0");
					...
					put(grammarAccess.getQueryAccess().getGroup_3_1(), "rule__Query__Group_3_1__0");
					...
					put(grammarAccess.getObjectTemplateAccess().getGroup_5(), "rule__ObjectTemplate__Group_5__0");
					put(grammarAccess.getPropertyTemplateItemAccess().getGroup(), "rule__PropertyTemplateItem__Group__0");
					...
					put(grammarAccess.getPackageDeclarationAccess().getTransformationAssignment_4(), "rule__PackageDeclaration__TransformationAssignment_4");
					put(grammarAccess.getImportAccess().getImportedNamespaceAssignment_1(), "rule__Import__ImportedNamespaceAssignment_1");
					put(grammarAccess.getTransformationAccess().getTransformationNameAssignment_1(), "rule__Transformation__TransformationNameAssignment_1");
					put(grammarAccess.getTransformationAccess().getDirectionsAssignment_3(), "rule__Transformation__DirectionsAssignment_3");
					put(grammarAccess.getTransformationAccess().getDirectionsAssignment_4_1(), "rule__Transformation__DirectionsAssignment_4_1");
					put(grammarAccess.getTransformationAccess().getRulesAssignment_7_0(), "rule__Transformation__RulesAssignment_7_0");
					put(grammarAccess.getTransformationAccess().getQueriesAssignment_7_1(), "rule__Transformation__QueriesAssignment_7_1");
					put(grammarAccess.getQueryAccess().getNameAssignment_1(), "rule__Query__NameAssignment_1");
					put(grammarAccess.getQueryAccess().getParamsAssignment_3_0(), "rule__Query__ParamsAssignment_3_0");
					put(grammarAccess.getQueryAccess().getParamsAssignment_3_1_1(), "rule__Query__ParamsAssignment_3_1_1");
					put(grammarAccess.getQueryAccess().getTypeAssignment_6(), "rule__Query__TypeAssignment_6");
					put(grammarAccess.getQueryAccess().getBodyAssignment_7(), "rule__Query__BodyAssignment_7");
					put(grammarAccess.getDirectionAccess().getNameAssignment_0(), "rule__Direction__NameAssignment_0");
					put(grammarAccess.getDirectionAccess().getImpAssignment_2(), "rule__Direction__ImpAssignment_2");
					put(grammarAccess.getRelationAccess().getTopRelationAssignment_0(), "rule__Relation__TopRelationAssignment_0");
					...
					put(grammarAccess.getRelationDomainAccess().getDirectionAssignment_2(), "rule__RelationDomain__DirectionAssignment_2");
					put(grammarAccess.getRelationDomainAccess().getRootTemplateAssignment_3(), "rule__RelationDomain__RootTemplateAssignment_3");
					put(grammarAccess.getObjectTemplateAccess().getNameAssignment_1(), "rule__ObjectTemplate__NameAssignment_1");
					put(grammarAccess.getObjectTemplateAccess().getTypeAssignment_3(), "rule__ObjectTemplate__TypeAssignment_3");
					put(grammarAccess.getObjectTemplateAccess().getWriteableAssignment_4(), "rule__ObjectTemplate__WriteableAssignment_4");
					put(grammarAccess.getObjectTemplateAccess().getPartAssignment_5_0(), "rule__ObjectTemplate__PartAssignment_5_0");
					put(grammarAccess.getPropertyTemplateItemAccess().getReferredPropertyAssignment_0(), "rule__PropertyTemplateItem__ReferredPropertyAssignment_0");
					put(grammarAccess.getPropertyTemplateItemAccess().getValueAssignment_2(), "rule__PropertyTemplateItem__ValueAssignment_2");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.eclipse.jqvt.ui.contentassist.antlr.internal.InternalJQVTParser typedParser = (org.eclipse.jqvt.ui.contentassist.antlr.internal.InternalJQVTParser) parser;
