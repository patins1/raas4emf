...
public class JQVTGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class PackageDeclarationElements extends AbstractParserRuleElementFinder {
		...
		//PackageDeclaration:
		//	"package" name=QualifiedName ";" imports+=Import* transformation=Transformation;
	...
	public class QualifiedNameWithWildCard2Elements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "QualifiedNameWithWildCard2");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class RelationDomainElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "RelationDomain");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ObjectTemplateElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "ObjectTemplate");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class PropertyTemplateItemElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "PropertyTemplateItem");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class QualifiedNameElements extends AbstractParserRuleElementFinder {
		...
		private final Keyword cFullStopKeyword_1_0_0_0 = (Keyword)cAlternatives_1_0_0.eContents().get(0);
		private final Keyword cColonColonKeyword_1_0_0_1 = (Keyword)cAlternatives_1_0_0.eContents().get(1);
	...
	private QualifiedNameWithWildCard2Elements pQualifiedNameWithWildCard2;
	...
	private RelationDomainElements pRelationDomain;
	private ObjectTemplateElements pObjectTemplate;
	private PropertyTemplateItemElements pPropertyTemplateItem;
	...
	public QualifiedNameWithWildCard2Elements getQualifiedNameWithWildCard2Access() {
		return (pQualifiedNameWithWildCard2 != null) ? pQualifiedNameWithWildCard2 : (pQualifiedNameWithWildCard2 = new QualifiedNameWithWildCard2Elements());
	}
	...
	public RelationDomainElements getRelationDomainAccess() {
		return (pRelationDomain != null) ? pRelationDomain : (pRelationDomain = new RelationDomainElements());
	}
	...
	public ObjectTemplateElements getObjectTemplateAccess() {
		return (pObjectTemplate != null) ? pObjectTemplate : (pObjectTemplate = new ObjectTemplateElements());
	}
	...
	public PropertyTemplateItemElements getPropertyTemplateItemAccess() {
		return (pPropertyTemplateItem != null) ? pPropertyTemplateItem : (pPropertyTemplateItem = new PropertyTemplateItemElements());
	}
