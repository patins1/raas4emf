 ...
 * <!-- end-user-doc -->
 * @see IFC2X3.IFC2X3Package#getIfcActuatorTypeEnum()
 * @model
 * @generated
 */
public enum IfcActuatorTypeEnum implements Enumerator {
	 ...
	 * @ordered
	 */
	ELECTRICACTUATOR(0, "ELECTRICACTUATOR", "ELECTRICACTUATOR"), /**
	 ...
	 * @ordered
	 */
	HANDOPERATEDACTUATOR(1, "HANDOPERATEDACTUATOR", "HANDOPERATEDACTUATOR"), /**
	 ...
	 * @ordered
	 */
	HYDRAULICACTUATOR(2, "HYDRAULICACTUATOR", "HYDRAULICACTUATOR"), /**
	 ...
	 * @ordered
	 */
	THERMOSTATICACTUATOR(4, "THERMOSTATICACTUATOR", "THERMOSTATICACTUATOR"), /**
	 ...
	 * @ordered
	 */
	public static final int ELECTRICACTUATOR_VALUE = 0;
	 ...
	 * @ordered
	 */
	public static final int HANDOPERATEDACTUATOR_VALUE = 1;
	 ...
	 * @ordered
	 */
	public static final int HYDRAULICACTUATOR_VALUE = 2;
	 ...
	 * @ordered
	 */
	public static final int THERMOSTATICACTUATOR_VALUE = 4;
