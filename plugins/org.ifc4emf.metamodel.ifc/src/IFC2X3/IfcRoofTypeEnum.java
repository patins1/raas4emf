 ...
 * <!-- end-user-doc -->
 * @see IFC2X3.IFC2X3Package#getIfcRoofTypeEnum()
 * @model
 * @generated
 */
public enum IfcRoofTypeEnum implements Enumerator {
	 ...
	 * @ordered
	 */
	FLAT_ROOF(0, "FLAT_ROOF", "FLAT_ROOF"), /**
	 ...
	 * @ordered
	 */
	GABLE_ROOF(2, "GABLE_ROOF", "GABLE_ROOF"), /**
	 ...
	 * @ordered
	 */
	HIPPED_GABLE_ROOF(4, "HIPPED_GABLE_ROOF", "HIPPED_GABLE_ROOF"), /**
	 ...
	 * @ordered
	 */
	GAMBREL_ROOF(5, "GAMBREL_ROOF", "GAMBREL_ROOF"), /**
	 ...
	 * @ordered
	 */
	MANSARD_ROOF(6, "MANSARD_ROOF", "MANSARD_ROOF"), /**
	 ...
	 * @ordered
	 */
	BARREL_ROOF(7, "BARREL_ROOF", "BARREL_ROOF"), /**
	 ...
	 * @ordered
	 */
	RAINBOW_ROOF(8, "RAINBOW_ROOF", "RAINBOW_ROOF"), /**
	 ...
	 * @ordered
	 */
	BUTTERFLY_ROOF(9, "BUTTERFLY_ROOF", "BUTTERFLY_ROOF"), /**
	 ...
	 * @ordered
	 */
	DOME_ROOF(11, "DOME_ROOF", "DOME_ROOF"), /**
	 ...
	 * @ordered
	 */
	public static final int FLAT_ROOF_VALUE = 0;
	 ...
	 * @ordered
	 */
	public static final int GABLE_ROOF_VALUE = 2;
	 ...
	 * @ordered
	 */
	public static final int HIP_ROOF_VALUE = 3;
	 ...
	 * @ordered
	 */
	public static final int HIPPED_GABLE_ROOF_VALUE = 4;
	 ...
	 * @ordered
	 */
	public static final int GAMBREL_ROOF_VALUE = 5;
	 ...
	 * @ordered
	 */
	public static final int MANSARD_ROOF_VALUE = 6;
	 ...
	 * @ordered
	 */
	public static final int BARREL_ROOF_VALUE = 7;
	 ...
	 * @ordered
	 */
	public static final int RAINBOW_ROOF_VALUE = 8;
	 ...
	 * @ordered
	 */
	public static final int BUTTERFLY_ROOF_VALUE = 9;
	 ...
	 * @ordered
	 */
	public static final int DOME_ROOF_VALUE = 11;
	 ...
	 * @ordered
	 */
	public static final int FREEFORM_VALUE = 12;
