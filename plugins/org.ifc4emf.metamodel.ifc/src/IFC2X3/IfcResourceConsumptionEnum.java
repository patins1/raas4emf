 ...
 * <!-- end-user-doc -->
 * @see IFC2X3.IFC2X3Package#getIfcResourceConsumptionEnum()
 * @model
 * @generated
 */
public enum IfcResourceConsumptionEnum implements Enumerator {
	 ...
	 * @ordered
	 */
	PARTIALLYCONSUMED(1, "PARTIALLYCONSUMED", "PARTIALLYCONSUMED"), /**
	 ...
	 * @ordered
	 */
	NOTOCCUPIED(5, "NOTOCCUPIED", "NOTOCCUPIED"), /**
	 ...
	 * @ordered
	 */
	public static final int PARTIALLYCONSUMED_VALUE = 1;
	 ...
	 * @ordered
	 */
	public static final int NOTOCCUPIED_VALUE = 5;
