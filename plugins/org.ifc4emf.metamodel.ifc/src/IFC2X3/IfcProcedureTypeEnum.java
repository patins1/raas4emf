 ...
 * <!-- end-user-doc -->
 * @see IFC2X3.IFC2X3Package#getIfcProcedureTypeEnum()
 * @model
 * @generated
 */
public enum IfcProcedureTypeEnum implements Enumerator {
	 ...
	 * @ordered
	 */
	ADVICE_CAUTION(0, "ADVICE_CAUTION", "ADVICE_CAUTION"), /**
	 ...
	 * @ordered
	 */
	ADVICE_WARNING(2, "ADVICE_WARNING", "ADVICE_WARNING"), /**
	 ...
	 * @ordered
	 */
	DIAGNOSTIC(4, "DIAGNOSTIC", "DIAGNOSTIC"), /**
	 ...
	 * @ordered
	 */
	public static final int ADVICE_CAUTION_VALUE = 0;
	 ...
	 * @ordered
	 */
	public static final int ADVICE_WARNING_VALUE = 2;
	 ...
	 * @ordered
	 */
	public static final int STARTUP_VALUE = 6;
