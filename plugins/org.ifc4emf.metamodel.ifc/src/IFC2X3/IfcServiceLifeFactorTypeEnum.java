 ...
 * <!-- end-user-doc -->
 * @see IFC2X3.IFC2X3Package#getIfcServiceLifeFactorTypeEnum()
 * @model
 * @generated
 */
public enum IfcServiceLifeFactorTypeEnum implements Enumerator {
	 ...
	 * @ordered
	 */
	AQUALITYOFCOMPONENTS(0, "A_QUALITYOFCOMPONENTS", "A_QUALITYOFCOMPONENTS"), /**
	 ...
	 * @ordered
	 */
	BDESIGNLEVEL(1, "B_DESIGNLEVEL", "B_DESIGNLEVEL"), /**
	 ...
	 * @ordered
	 */
	CWORKEXECUTIONLEVEL(2, "C_WORKEXECUTIONLEVEL", "C_WORKEXECUTIONLEVEL"), /**
	 ...
	 * @ordered
	 */
	DINDOORENVIRONMENT(3, "D_INDOORENVIRONMENT", "D_INDOORENVIRONMENT"), /**
	 ...
	 * @ordered
	 */
	FINUSECONDITIONS(5, "F_INUSECONDITIONS", "F_INUSECONDITIONS"), /**
	 ...
	 * @ordered
	 */
	GMAINTENANCELEVEL(6, "G_MAINTENANCELEVEL", "G_MAINTENANCELEVEL"), /**
	 ...
	 * @ordered
	 */
	public static final int AQUALITYOFCOMPONENTS_VALUE = 0;
	 ...
	 * @ordered
	 */
	public static final int BDESIGNLEVEL_VALUE = 1;
	 ...
	 * @ordered
	 */
	public static final int CWORKEXECUTIONLEVEL_VALUE = 2;
	 ...
	 * @ordered
	 */
	public static final int DINDOORENVIRONMENT_VALUE = 3;
	 ...
	 * @ordered
	 */
	public static final int FINUSECONDITIONS_VALUE = 5;
	 ...
	 * @ordered
	 */
	public static final int GMAINTENANCELEVEL_VALUE = 6;
