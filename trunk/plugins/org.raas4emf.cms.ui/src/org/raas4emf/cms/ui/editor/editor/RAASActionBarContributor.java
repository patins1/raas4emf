...
/**
 * This is the action bar contributor for the RAAS model editor. <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class RAASActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener {
	 ...
	 * @generated
	 */
	protected IAction showPropertiesViewAction = new Action(RAASEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
		@Override
		public void run() {
			try {
				getPage().showView("org.eclipse.ui.views.PropertySheet");
			} catch (PartInitException exception) {
				RAASEditorPlugin.INSTANCE.log(exception);
			}
		}
	};
	 ...
	 * @generated
	 */
	protected IAction refreshViewerAction = new Action(RAASEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
		@Override
	 ...
	 * @generated
	 */
	public RAASActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("raas-settings"));
		toolBarManager.add(new Separator("raas-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(RAASEditorPlugin.INSTANCE.getString("_UI_RAASEditor_menu"), "editorMenuID");
		try {
		...
		//
		createChildMenuManager = new MenuManager(RAASEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		submenuManager.insertBefore("additions", createChildMenuManager);

		// Prepare for CreateSibling item addition or removal.
		//
		createSiblingMenuManager = new MenuManager(RAASEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
	...
	/**
	 * This populates the specified <code>manager</code> with {@link org.eclipse.jface.action.ActionContributionItem}s based on the {@link org.eclipse.jface.action.IAction}s contained in the <code>actions</code> collection, by inserting them before the specified contribution item <code>contributionID</code>. If
	 * <code>contributionID</code> is <code>null</code>, they are simply added. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	...
	public void menuAboutToShow(IMenuManager menuManager) {
		...
		submenuManager = new MenuManager(RAASEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		populateManager(submenuManager, createChildActions, null);
		menuManager.insertBefore("edit", submenuManager);

		submenuManager = new MenuManager(RAASEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
	...
	protected DeleteAction createDeleteAction() {
		// @GENERATED NOT
		return new RAASDeleteAction(removeAllReferencesOnDelete());
	}
