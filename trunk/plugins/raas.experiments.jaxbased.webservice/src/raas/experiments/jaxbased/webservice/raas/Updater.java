...
/**
 * Class to update a (normaly persistent) object by the contents of a given
 * (normally transient) object. This class basically just clears all content of
 * the old object and copies the content of the new object into the old object
 * by deriving from {@link Copier}.
 */
public class Updater extends Copier {
	...
	/**
	 * Reuse old objects if possible before creating a copy in the super method.
	 * Reuse is only required for {@link #persistentObject} in order to actually
	 * update it. For contained persistent objects, it may be a speed-up to
	 * reuse them, otherwise they should get deleted and created from the
	 * scratch.
	 */
	@Override
	...
	/**
	 * Clear references in old object, since any reference not defined by the
	 * new object shall be deleted.
	 */
	@Override
