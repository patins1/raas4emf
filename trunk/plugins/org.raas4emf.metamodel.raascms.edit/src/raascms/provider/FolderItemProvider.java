...
/**
 * This is the item provider adapter for a {@link raascms.Folder} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FolderItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RaascmsPackage.Literals.FOLDER__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RaascmsPackage.Literals.FOLDER__ARTIFACTS);
			childrenFeatures.add(RaascmsPackage.Literals.FOLDER__FOLDERS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Folder.class)) {
			case RaascmsPackage.FOLDER__NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case RaascmsPackage.FOLDER__ARTIFACTS:
			case RaascmsPackage.FOLDER__FOLDERS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(RaascmsPackage.Literals.FOLDER__ARTIFACTS,
				 RaascmsFactory.eINSTANCE.createArtifact()));

		newChildDescriptors.add
			(createChildParameter
				(RaascmsPackage.Literals.FOLDER__FOLDERS,
				 RaascmsFactory.eINSTANCE.createFolder()));
	}
