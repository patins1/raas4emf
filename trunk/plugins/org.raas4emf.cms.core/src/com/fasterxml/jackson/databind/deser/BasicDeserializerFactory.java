    ...
    implements java.io.Serializable
{
        ...
        throws JsonMappingException
    {
        ...
        if (b == null) {
        	Object converter = ai.findDeserializationContentConverter(propertyEntity);
        	//!!!
        	if (converter instanceof AdapterConverter) {
				AdapterConverter adapterConverter = (AdapterConverter) converter;
        		contentType = adapterConverter.getInputType(null);
        	}
