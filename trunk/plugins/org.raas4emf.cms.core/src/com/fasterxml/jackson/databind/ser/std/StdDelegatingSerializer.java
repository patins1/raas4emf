...
public class StdDelegatingSerializer extends StdSerializer<Object> implements ContextualSerializer, ResolvableSerializer, JsonFormatVisitable, SchemaAware {
	...
	public JsonSerializer<?> createContextual(SerializerProvider provider, BeanProperty property) throws JsonMappingException {
		...
		if (delSer == null) {
			...
			/*
			 * 02-Apr-2015, tatu: For "dynamic case", where type is only specified as java.lang.Object (or missing generic), [databind#731]
			 */
	...
	public void serialize(Object value, JsonGenerator gen, SerializerProvider provider) throws IOException {
		...
		if (_delegateSerializer != null && _delegateSerializer.handledType().isInstance(delegateValue) && _delegateSerializer.handledType() != delegateValue.getClass()/* !!! */) {
			ser = provider.findTypedValueSerializer(delegateValue.getClass(), true, null);
		}
		if (ser == null) {
	...
	public void acceptJsonFormatVisitor(JsonFormatVisitorWrapper visitor, JavaType typeHint) throws JsonMappingException {
		/*
		 * 03-Sep-2012, tatu: Not sure if this can be made to really work properly... but for now, try this:
		 */
	 ...
	 * <P>
	 * The default implementation uses configured {@link Converter} to do conversion.
	 * 
	 * @param value
	 *            Value to convert
	 * 
	...
	/**
	 * Helper method used for locating serializer to use in dynamic use case, where actual type value gets converted to is not specified beyond basic {@link java.lang.Object}, and where serializer needs to be located dynamically based on actual value type.
	 *
	 * @since 2.6
	 */
