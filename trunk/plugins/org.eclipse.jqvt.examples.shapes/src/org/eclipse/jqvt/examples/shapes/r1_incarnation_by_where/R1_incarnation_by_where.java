...
public class R1_incarnation_by_where {
	...
	public static void main(String[] args) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException, IOException {
		...
		engine.execute(transformation, "src/org/eclipse/jqvt/examples/shapes/r1_incarnation_by_where/source.shapes", "src/org/eclipse/jqvt/examples/shapes/r1_incarnation_by_where/target2.shapes");
	}
