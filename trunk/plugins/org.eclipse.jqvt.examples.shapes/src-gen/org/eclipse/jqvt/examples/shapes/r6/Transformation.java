...
import org.eclipse.jqvt.examples.shapes.r6.ArrowSource2ArrowSource;
import org.eclipse.jqvt.examples.shapes.r6.ArrowTarget2ArrowTarget;
import org.eclipse.jqvt.examples.shapes.r6.MapArrow;
import org.eclipse.jqvt.examples.shapes.r6.MapBlock;
import org.eclipse.jqvt.examples.shapes.r6.MapBlockAsShape;
import org.eclipse.jqvt.examples.shapes.r6.MapCircle;
import org.eclipse.jqvt.examples.shapes.r6.MapRootBlock;
import org.eclipse.jqvt.examples.shapes.r6.MapSquare;
import org.eclipse.jqvt.examples.shapes.r6.MapTriangle;
import org.eclipse.jqvt.examples.shapes.r6.ModelElementName2ModelElementName;
import org.eclipse.jqvt.examples.shapes.r6.ModelElementblock2ModelElementblock;
...
public abstract class Transformation {
  ...
  public boolean MapBlockAsShape(final Object s, final Object t) {
    throw new RuntimeException("should never be called");
  }
  ...
  public HashMap<MapBlockAsShape,MapBlockAsShape> traces_MapBlockAsShape;
  
  public MapBlockAsShape top_relation_MapBlockAsShape(final Block s) {
    MapBlockAsShape result = new MapBlockAsShape(s);
    if (traces_MapBlockAsShape==null) traces_MapBlockAsShape = new java.util.HashMap<MapBlockAsShape,MapBlockAsShape>();
    if (traces_MapBlockAsShape.containsKey(result)) {
    	result = traces_MapBlockAsShape.get(result);
    } else {
    	traces_MapBlockAsShape.put(result,null);
    	this.relStack.push(result);
    	boolean execResult = result.execute(this);
    	this.relStack.pop();
    	if (!execResult) return null;
    	traces_MapBlockAsShape.put(result,result);
  ...
  public static List<String> top_relation_MapBlockAsShape_directions = java.util.Arrays.asList("source", "target");
  ...
  public List<String> topOrder = java.util.Arrays.asList( "ArrowSource2ArrowSource", "ArrowTarget2ArrowTarget", "ModelElementName2ModelElementName", "ModelElementblock2ModelElementblock", "Source2Target", "MapRootBlock", "MapBlock", "MapBlockAsShape", "MapCircle", "MapTriangle", "MapSquare", "MapArrow" );
