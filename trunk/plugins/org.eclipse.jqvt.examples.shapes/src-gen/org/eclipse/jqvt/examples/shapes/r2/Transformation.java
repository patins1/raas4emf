...
import org.eclipse.jqvt.examples.shapes.r2.ArrowSource2ArrowSource;
import org.eclipse.jqvt.examples.shapes.r2.ArrowTarget2ArrowTarget;
...
import org.eclipse.jqvt.examples.shapes.r2.ModelElementName2ModelElementName;
import org.eclipse.jqvt.examples.shapes.r2.ModelElementblock2ModelElementblock;
...
public abstract class Transformation {
  ...
  public RootBlock findRoot(final Block block) {
    RootBlock _xifexpression = null;
    if ((block instanceof RootBlock)) {
      _xifexpression = ((RootBlock) block);
    } else {
      Block _block = block.getBlock();
      RootBlock _findRoot = this.findRoot(_block);
      _xifexpression = _findRoot;
    }
