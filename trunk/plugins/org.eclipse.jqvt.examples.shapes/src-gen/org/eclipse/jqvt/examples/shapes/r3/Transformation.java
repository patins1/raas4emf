...
import org.eclipse.jqvt.examples.shapes.r3.MapArrow;
...
import org.eclipse.jqvt.examples.shapes.r3.ModelElementName2ModelElementName;
import org.eclipse.jqvt.examples.shapes.r3.ModelElementblock2ModelElementblock;
...
public abstract class Transformation {
  ...
  public boolean MapArrow(final Object sourceArrow, final Object targetSquare, final Object targetArrow1, final Object targetArrow2) {
    throw new RuntimeException("should never be called");
  }
  ...
  public MapArrow top_relation_MapArrow(final Arrow sourceArrow) {
    MapArrow result = new MapArrow(sourceArrow);
  ...
  public static List<String> top_relation_MapArrow_directions = java.util.Arrays.asList("source", "target", "target", "target");
  
  public static List<String> global_direction = java.util.Arrays.asList("source", "target");
  
  public List<String> topOrder = java.util.Arrays.asList( "ModelElementName2ModelElementName", "ModelElementblock2ModelElementblock", "Source2Target", "MapRootBlock", "MapBlock", "MapCircle", "MapTriangle", "MapSquare", "MapArrow" );
