...
public interface IRepository {
	 ...
	 * @throws IOException
	 */
	void openSession(MessageContext context) throws IOException;
	...
	/**
	 * Since proxies created by unmarshalling have URIs of the form "#id", the proxy URIs shall now be fixed here, e.g. pointing to a resource
	 * 
	 * @param obj
	 */
