 ...
 * <!-- end-user-doc -->
 * @see IFC2X3.IFC2X3Package#getIfcSensorTypeEnum()
 * @model
 * @generated
 */
public enum IfcSensorTypeEnum implements Enumerator {
	 ...
	 * @ordered
	 */
	CO2SENSOR(0, "CO2SENSOR", "CO2SENSOR"), /**
	 ...
	 * @ordered
	 */
	FLOWSENSOR(2, "FLOWSENSOR", "FLOWSENSOR"), /**
	 ...
	 * @ordered
	 */
	GASSENSOR(3, "GASSENSOR", "GASSENSOR"), /**
	 ...
	 * @ordered
	 */
	HUMIDITYSENSOR(5, "HUMIDITYSENSOR", "HUMIDITYSENSOR"), /**
	 ...
	 * @ordered
	 */
	LIGHTSENSOR(6, "LIGHTSENSOR", "LIGHTSENSOR"), /**
	 ...
	 * @ordered
	 */
	MOISTURESENSOR(7, "MOISTURESENSOR", "MOISTURESENSOR"), /**
	 ...
	 * @ordered
	 */
	PRESSURESENSOR(9, "PRESSURESENSOR", "PRESSURESENSOR"), /**
	 ...
	 * @ordered
	 */
	SMOKESENSOR(10, "SMOKESENSOR", "SMOKESENSOR"), /**
	 ...
	 * @ordered
	 */
	public static final int CO2SENSOR_VALUE = 0;
	 ...
	 * @ordered
	 */
	public static final int FLOWSENSOR_VALUE = 2;
	 ...
	 * @ordered
	 */
	public static final int GASSENSOR_VALUE = 3;
	 ...
	 * @ordered
	 */
	public static final int HUMIDITYSENSOR_VALUE = 5;
	 ...
	 * @ordered
	 */
	public static final int LIGHTSENSOR_VALUE = 6;
	 ...
	 * @ordered
	 */
	public static final int MOISTURESENSOR_VALUE = 7;
	 ...
	 * @ordered
	 */
	public static final int PRESSURESENSOR_VALUE = 9;
	 ...
	 * @ordered
	 */
	public static final int SMOKESENSOR_VALUE = 10;
