 ...
 * <!-- end-user-doc -->
 * @see IFC2X3.IFC2X3Package#getIfcPumpTypeEnum()
 * @model
 * @generated
 */
public enum IfcPumpTypeEnum implements Enumerator {
	 ...
	 * @ordered
	 */
	CIRCULATOR(0, "CIRCULATOR", "CIRCULATOR"), /**
	 ...
	 * @ordered
	 */
	ENDSUCTION(1, "ENDSUCTION", "ENDSUCTION"), /**
	 ...
	 * @ordered
	 */
	SPLITCASE(2, "SPLITCASE", "SPLITCASE"), /**
	 ...
	 * @ordered
	 */
	VERTICALINLINE(3, "VERTICALINLINE", "VERTICALINLINE"), /**
	 ...
	 * @ordered
	 */
	VERTICALTURBINE(4, "VERTICALTURBINE", "VERTICALTURBINE"), /**
	 ...
	 * @ordered
	 */
	public static final int CIRCULATOR_VALUE = 0;
	 ...
	 * @ordered
	 */
	public static final int ENDSUCTION_VALUE = 1;
	 ...
	 * @ordered
	 */
	public static final int SPLITCASE_VALUE = 2;
	 ...
	 * @ordered
	 */
	public static final int VERTICALINLINE_VALUE = 3;
	 ...
	 * @ordered
	 */
	public static final int VERTICALTURBINE_VALUE = 4;
