 ...
 * <!-- end-user-doc -->
 * @see IFC2X3.IFC2X3Package#getIfcGeometricProjectionEnum()
 * @model
 * @generated
 */
public enum IfcGeometricProjectionEnum implements Enumerator {
	 ...
	 * @ordered
	 */
	GRAPH_VIEW(0, "GRAPH_VIEW", "GRAPH_VIEW"), /**
	 ...
	 * @ordered
	 */
	SKETCH_VIEW(1, "SKETCH_VIEW", "SKETCH_VIEW"), /**
	 ...
	 * @ordered
	 */
	MODEL_VIEW(2, "MODEL_VIEW", "MODEL_VIEW"), /**
	 ...
	 * @ordered
	 */
	PLAN_VIEW(3, "PLAN_VIEW", "PLAN_VIEW"), /**
	 ...
	 * @ordered
	 */
	REFLECTED_PLAN_VIEW(4, "REFLECTED_PLAN_VIEW", "REFLECTED_PLAN_VIEW"), /**
	 ...
	 * @ordered
	 */
	SECTION_VIEW(5, "SECTION_VIEW", "SECTION_VIEW"), /**
