 ...
 * <!-- end-user-doc -->
 * @see IFC2X3.IFC2X3Package#getIfcFootingTypeEnum()
 * @model
 * @generated
 */
public enum IfcFootingTypeEnum implements Enumerator {
	 ...
	 * @ordered
	 */
	FOOTING_BEAM(0, "FOOTING_BEAM", "FOOTING_BEAM"), /**
	 ...
	 * @ordered
	 */
	PAD_FOOTING(1, "PAD_FOOTING", "PAD_FOOTING"), /**
	 ...
	 * @ordered
	 */
	STRIP_FOOTING(3, "STRIP_FOOTING", "STRIP_FOOTING"), /**
