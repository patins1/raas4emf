 ...
 * <!-- end-user-doc -->
 * @see IFC2X3.IFC2X3Package#getIfcCondenserTypeEnum()
 * @model
 * @generated
 */
public enum IfcCondenserTypeEnum implements Enumerator {
	 ...
	 * @ordered
	 */
	WATERCOOLEDSHELLTUBE(0, "WATERCOOLEDSHELLTUBE", "WATERCOOLEDSHELLTUBE"), /**
	 ...
	 * @ordered
	 */
	WATERCOOLEDSHELLCOIL(1, "WATERCOOLEDSHELLCOIL", "WATERCOOLEDSHELLCOIL"), /**
	 ...
	 * @ordered
	 */
	WATERCOOLEDTUBEINTUBE(2, "WATERCOOLEDTUBEINTUBE", "WATERCOOLEDTUBEINTUBE"), /**
	 ...
	 * @ordered
	 */
	WATERCOOLEDBRAZEDPLATE(3, "WATERCOOLEDBRAZEDPLATE", "WATERCOOLEDBRAZEDPLATE"), /**
	 ...
	 * @ordered
	 */
	EVAPORATIVECOOLED(5, "EVAPORATIVECOOLED", "EVAPORATIVECOOLED"), /**
	 ...
	 * @ordered
	 */
	public static final int WATERCOOLEDSHELLTUBE_VALUE = 0;
	 ...
	 * @ordered
	 */
	public static final int WATERCOOLEDSHELLCOIL_VALUE = 1;
	 ...
	 * @ordered
	 */
	public static final int WATERCOOLEDTUBEINTUBE_VALUE = 2;
	 ...
	 * @ordered
	 */
	public static final int WATERCOOLEDBRAZEDPLATE_VALUE = 3;
	 ...
	 * @ordered
	 */
	public static final int EVAPORATIVECOOLED_VALUE = 5;
