 ...
 * <!-- end-user-doc -->
 * @see IFC2X3.IFC2X3Package#getIfcUnitaryEquipmentTypeEnum()
 * @model
 * @generated
 */
public enum IfcUnitaryEquipmentTypeEnum implements Enumerator {
	 ...
	 * @ordered
	 */
	AIRHANDLER(0, "AIRHANDLER", "AIRHANDLER"), /**
	 ...
	 * @ordered
	 */
	AIRCONDITIONINGUNIT(1, "AIRCONDITIONINGUNIT", "AIRCONDITIONINGUNIT"), /**
	 ...
	 * @ordered
	 */
	SPLITSYSTEM(2, "SPLITSYSTEM", "SPLITSYSTEM"), /**
	 ...
	 * @ordered
	 */
	public static final int AIRHANDLER_VALUE = 0;
	 ...
	 * @ordered
	 */
	public static final int AIRCONDITIONINGUNIT_VALUE = 1;
	 ...
	 * @ordered
	 */
	public static final int SPLITSYSTEM_VALUE = 2;
