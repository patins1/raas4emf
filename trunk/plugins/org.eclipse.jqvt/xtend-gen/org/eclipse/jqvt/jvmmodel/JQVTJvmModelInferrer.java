...
public class JQVTJvmModelInferrer extends AbstractModelInferrer {
  ...
  @Inject
  @Extension
  private TopRelationSorter _topRelationSorter;
      ...
      if (useTraces) {
        ...
        _builder.newLine();
        {
          if (onlyTraces) {
            ...
            _builder.newLine();
            _builder.append("\t");
            _builder.append("Set<Object> waiting = this.waitingList.get(result);");
            _builder.newLine();
            _builder.append("\t");
            _builder.append("if(waiting == null)");
            _builder.newLine();
            _builder.append("\t");
            _builder.append("\t");
            _builder.append("this.waitingList.put(result, (waiting = new java.util.HashSet<Object>()));");
            _builder.newLine();
            _builder.append("\t");
            _builder.append("waiting.addAll(this.relStack);");
            _builder.newLine();
            _builder.append("\t");
            ...
            _builder.append("\t");
            _builder.append("this.relStack.push(result);");
            _builder.newLine();
            _builder.append("\t");
            _builder.append("boolean execResult = result.execute(this);");
            _builder.newLine();
            _builder.append("\t");
            _builder.append("this.relStack.pop();");
            _builder.newLine();
            _builder.append("\t");
            _builder.append("if (!execResult) return null;");
            _builder.newLine();
            _builder.append("\t");
            ...
            _builder.newLine();
            _builder.append("\t");
            _builder.append("Set<Object> waitingRelList = this.waitingList.get(result);");
            _builder.newLine();
            _builder.append("\t");
            _builder.append("if(waitingRelList != null){");
            _builder.newLine();
            _builder.append("\t");
            _builder.append("\t");
            _builder.append("for(Object waitingRel : waitingRelList){");
            _builder.newLine();
            _builder.append("\t");
            _builder.append("\t\t");
            _builder.append("try{");
            ...
            _builder.append("\t");
            _builder.append("\t\t\t");
            _builder.append("Method m = waitingRel.getClass().getMethod(\"execute\",Transformation.class);");
            _builder.newLine();
            _builder.append("\t");
            _builder.append("\t\t\t");
            _builder.append("m.invoke(waitingRel, this);");
            _builder.newLine();
            _builder.append("\t");
            _builder.append("\t\t\t");
            _builder.append("//System.out.println(\"Re-execute: \" + waitingRel);");
            _builder.newLine();
            _builder.append("\t");
            _builder.append("\t\t");
            _builder.append("}");
            ...
            _builder.append("\t");
            _builder.append("\t");
            _builder.append("this.waitingList.get(result).clear();");
            _builder.newLine();
            _builder.append("\t");
            _builder.append("}");
            _builder.newLine();
  ...
  protected void _infer(final Transformation transformation, final IJvmDeclaredTypeAcceptor acceptor, final boolean isPrelinkingPhase) {
    ...
    for (final Relation relation : _rules) {
      {
        ...
        final JvmGenericType c = this._jvmTypesBuilder.toClass(relation, _fullyQualifiedName_1, _function_1);
        ...
        if (_notEquals) {
          ...
          for (final XVariableDeclaration feature : _values) {
            {
              ...
              final JvmField field = this._jvmTypesBuilder.toField(feature, _name, _type);
          ...
          for (final DependencyInfo info : _sortSnippetsOfRelation) {
            {
              ...
              if (!_matched) {
                if (clause instanceof ObjectTemplate) {
                  ...
                  if (!info.isTarget) {
                    ...
                    JvmTypeReference _type = _objectTemplate.getType();
                    boolean _notEquals_1 = (!Objects.equal(_type, null));
                    _and_2 = (info.isTarget && _notEquals_1);
                  }
                  if (!_and_2) {
                    _and_1 = false;
                  } else {
                    ...
                    boolean _not = (!(_type_2 instanceof JvmPrimitiveType));
                    _and_1 = (_and_2 && _not);
                  }
                  if (!_and_1) {
                    _and = false;
                  ...
                  if (_and) {
                    ...
                    StringConcatenation _builder_4 = new StringConcatenation();
                    {
                      ...
                      if (_or) {
                        ...
                        String _name_1 = _objectTemplate.getName();
              ...
              if (!_matched) {
                if (clause instanceof PropertyTemplateItem) {
                  ...
                  final String propName = JQVTUtils.toPropertyName(_referredProperty);
                  boolean _notEquals_1 = (!Objects.equal(propName, null));
                  if (_notEquals_1) {
                    ...
                    final String getter = JQVTUtils.toGetterName(_referredProperty_1);
                    ...
                    if (_notEquals_2) {
                      ...
                      String _name_1 = _asVar_1.getName();
                      rhsExp = _name_1;
                    } else {
                      ...
                      JvmOperation _method = this._jvmTypesBuilder.toMethod(_eNull, _plus_2, _returnType_1, _function_2);
                      this._jvmTypesBuilder.<JvmOperation>operator_add(_members, _method);
                    }
                    StringConcatenation _builder_3 = new StringConcatenation();
                    _builder_3.append("trafo.logFailure(");
                    ICompositeNode _node = NodeModelUtils.getNode(_propertyTemplateItem);
                    int _startLine = _node.getStartLine();
                    _builder_3.append(_startLine, "");
                    _builder_3.append(");");
                    _builder_3.newLineIfNotEmpty();
                    final String printFailure = _builder_3.toString();
                    StringConcatenation _builder_4 = new StringConcatenation();
                    _builder_4.append("trafo.logSuccess(");
                    ICompositeNode _node_1 = NodeModelUtils.getNode(_propertyTemplateItem);
                    int _startLine_1 = _node_1.getStartLine();
                    _builder_4.append(_startLine_1, "");
                    _builder_4.append(");");
                    _builder_4.newLineIfNotEmpty();
                    final String printSuccess = _builder_4.toString();
                    ...
                    _builder_5.append(_qVTWithinComment, "");
                    ...
                    if (info.isTarget) {
                      ...
                      if (!isMany) {
                        ...
                        _and = (isMany && (_value_3 instanceof ObjectTemplate));
                      }
                      if (_and) {
                        StringConcatenation _builder_6 = new StringConcatenation();
                        String _name_2 = objectTemplate.getName();
                        ...
                        if (isMany) {
                          ...
                          _builder_7.append(".");
                          _builder_7.append(getter, "");
                          _builder_7.append("().retainAll(");
                          _builder_7.append(rhsExp, "");
                          _builder_7.append(");");
                          ...
                          String _setterName = JQVTUtils.toSetterName(_referredProperty_2);
                          _builder_8.append(_setterName, "");
                          _builder_8.append("(");
                          _builder_8.append(rhsExp, "");
                          _builder_8.append(");");
                          _builder_8.newLineIfNotEmpty();
                          mapMethod.append(_builder_8);
                        }
                      }
                    } else {
                      boolean _and_1 = false;
                      ...
                      if (!(_value_4 instanceof ObjectTemplate)) {
                        ...
                        _and_1 = ((_value_4 instanceof ObjectTemplate) && isMany);
                      }
                      if (_and_1) {
                        ...
                        if (_equals) {
                          ...
                          _builder_9.append("boolean result = false;");
                          _builder_9.newLine();
                          mapMethod.append(_builder_9);
                        }
                        StringConcatenation _builder_10 = new StringConcatenation();
                        _builder_10.append("continue;");
                        _builder_10.newLine();
                        stopTuple = _builder_10.toString();
                        ...
                        JvmTypeReference _type = rhs.getType();
                        final boolean conformant = this._jvmOnlyTypeConformanceComputer.isConformant(_type, componentType);
                        StringConcatenation _builder_11 = new StringConcatenation();
                        _builder_11.append("for (");
                        String _qualifiedName = componentType.getQualifiedName();
                        _builder_11.append(_qualifiedName, "");
                        _builder_11.append(" __");
                        String _name_6 = rhs.getName();
                        _builder_11.append(_name_6, "");
                        _builder_11.append(" : ");
                        String _name_7 = objectTemplate.getName();
                        _builder_11.append(_name_7, "");
                        _builder_11.append(".");
                        _builder_11.append(getter, "");
                        _builder_11.append("()) {");
                        _builder_11.newLineIfNotEmpty();
                        {
                          boolean _not = (!conformant);
                          if (_not) {
                            _builder_11.append("if (!(__");
                            String _name_8 = rhs.getName();
                            _builder_11.append(_name_8, "");
                            _builder_11.append(" instanceof ");
                            String _simpleTypeName = this.simpleTypeName(rhs);
                            _builder_11.append(_simpleTypeName, "");
                            _builder_11.append(")) {");
                            _builder_11.append(printFailure, "");
                            _builder_11.append(stopTuple, "");
                            _builder_11.append("}");
                            _builder_11.append(printSuccess, "");
                          }
                        }
                        _builder_11.newLineIfNotEmpty();
                        ...
                        _builder_11.append(" = ");
                        {
                          ...
                          if (_not_1) {
                            ...
                            _builder_11.append(_simpleTypeName_1, "");
                            _builder_11.append(")");
                          }
                        }
                        _builder_11.append("__");
                        ...
                        if (_and_2) {
                          ...
                          JvmTypeReference _type_1 = rhs_1.getType();
                          JvmTypeReference _returnType_3 = field.getReturnType();
                          final boolean conformant_1 = this._jvmOnlyTypeConformanceComputer.isConformant(_type_1, _returnType_3);
                          StringConcatenation _builder_12 = new StringConcatenation();
                          {
                            boolean _not_3 = (!conformant_1);
                            if (_not_3) {
                              _builder_12.append("if (!(");
                              String _name_11 = objectTemplate.getName();
                              _builder_12.append(_name_11, "");
                              _builder_12.append(".");
                              _builder_12.append(getter, "");
                              _builder_12.append("() instanceof ");
                              String _simpleTypeName_2 = this.simpleTypeName(rhs_1);
                              _builder_12.append(_simpleTypeName_2, "");
                              _builder_12.append(")) {");
                              _builder_12.append(printFailure, "");
                              _builder_12.append(stopTuple, "");
                              _builder_12.append("}");
                              _builder_12.append(printSuccess, "");
                            }
                          }
                          _builder_12.newLineIfNotEmpty();
                          {
                            ...
                            if (!conformant_1) {
                              ...
                              if ((_value_10 instanceof ObjectTemplate)) {
                                ...
                                if (!(_type_3 instanceof JvmPrimitiveType)) {
                                  _and_5 = false;
                                } else {
                                  JvmTypeReference _returnType_4 = field.getReturnType();
                                  JvmType _type_4 = _returnType_4.getType();
                                  boolean _not_4 = (!(_type_4 instanceof JvmPrimitiveType));
                                  _and_5 = ((_type_3 instanceof JvmPrimitiveType) && _not_4);
                                }
                                _or = ((_value_10 instanceof ObjectTemplate) || _and_5);
                              }
                              _and_4 = (conformant_1 && _or);
                            }
                            if (_and_4) {
                              _builder_12.append("if (");
                          ...
                          _builder_12.append(" = ");
                          {
                            ...
                            if (_not_5) {
                              ...
                              _builder_12.append(_simpleTypeName_3, "");
                              _builder_12.append(")");
                            }
                          }
                          _builder_12.append(" ");
                          String _name_14 = objectTemplate.getName();
                          _builder_12.append(_name_14, "");
                          _builder_12.append(".");
                          _builder_12.append(getter, "");
                          _builder_12.append("();");
                          _builder_12.newLineIfNotEmpty();
                          mapMethod.append(_builder_12);
                        } else {
                          ...
                          _builder_13.append(".");
                          _builder_13.append(getter, "");
                          _builder_13.append("() == null ? ");
                          _builder_13.append(rhsExp, "");
                          _builder_13.append(" != null : !");
                          String _name_16 = objectTemplate.getName();
                          _builder_13.append(_name_16, "");
                          _builder_13.append(".");
                          _builder_13.append(getter, "");
                          _builder_13.append("().equals(");
                          _builder_13.append(rhsExp, "");
                          _builder_13.append(")) {");
                          _builder_13.append(printFailure, "");
                          _builder_13.append(stopTuple, "");
                          _builder_13.append("}");
                          _builder_13.append(printSuccess, "");
                          _builder_13.newLineIfNotEmpty();
                          mapMethod.append(_builder_13);
                        }
                      }
                    }
                  }
              ...
              if (!_matched) {
                if (clause instanceof XExpression) {
                  ...
                  JvmOperation _method = this._jvmTypesBuilder.toMethod(_eNull, _plus, _xifexpression, _function_2);
                  this._jvmTypesBuilder.<JvmOperation>operator_add(_members, _method);
                  StringConcatenation _builder_3 = new StringConcatenation();
                  _builder_3.append("trafo.logFailure(");
                  ICompositeNode _node = NodeModelUtils.getNode(_xExpression);
                  int _startLine = _node.getStartLine();
                  _builder_3.append(_startLine, "");
                  _builder_3.append(");");
                  _builder_3.newLineIfNotEmpty();
                  ...
                  StringConcatenation _builder_4 = new StringConcatenation();
                  _builder_4.append("trafo.logSuccess(");
                  ICompositeNode _node_1 = NodeModelUtils.getNode(_xExpression);
                  int _startLine_1 = _node_1.getStartLine();
                  _builder_4.append(_startLine_1, "");
                  _builder_4.append(");");
                  _builder_4.newLineIfNotEmpty();
                  ...
                  {
                    if (booleanTyped) {
                      _builder_5.append("if (!evaluateClause");
                      _builder_5.append(i, "");
                      _builder_5.append("()) {");
                      _builder_5.append(printFailure, "");
                      _builder_5.append(stopTuple, "");
                      _builder_5.append("}");
                      _builder_5.append(printSuccess, "");
                    } else {
                      _builder_5.append("evaluateClause");
                      _builder_5.append(i, "");
                      _builder_5.append("();");
                    }
                  }
          ...
          JvmOperation _method = this._jvmTypesBuilder.toMethod(_eNull, "execute", _newTypeRef, _function_2);
          this._jvmTypesBuilder.<JvmOperation>operator_add(_members, _method);
        }
      }
    }
    ...
    for (final Relation relation_1 : _rules_1) {
      ...
      String _name = relation_1.getName();
      ...
      JvmOperation _method = this._jvmTypesBuilder.toMethod(relation_1, _name, _newTypeRef, _function_1);
      this._jvmTypesBuilder.<JvmOperation>operator_add(_members, _method);
    }
    ...
    for (final Query query : _queries) {
      ...
      JvmOperation _method_1 = this._jvmTypesBuilder.toMethod(query, _name_1, _type, _function_2);
      this._jvmTypesBuilder.<JvmOperation>operator_add(_members_1, _method_1);
    }
    JvmTypeReference _newTypeRef_1 = this._jvmTypesBuilder.newTypeRef(transformation, "java.lang.String");
    final JvmTypeReference typeStringArray = this._jvmTypesBuilder.newTypeRef(transformation, "java.util.List", _newTypeRef_1);
    ...
    for (final Relation relation_2 : _sortedRelations) {
      {
        ...
        if (_notEquals) {
          ...
          if (_isTopRelation_1) {
            ...
            String _plus_1 = ("top_relation_" + _name_3);
            String _plus_2 = (_plus_1 + "_directions");
            final Procedure1<JvmField> _function_4 = new Procedure1<JvmField>() {
              public void apply(final JvmField it) {
                EList<RelationDomain> _domains = relation_2.getDomains();
                final Function1<RelationDomain,String> _function = new Function1<RelationDomain,String>() {
                  public String apply(final RelationDomain e) {
                ...
                List<String> _map = ListExtensions.<RelationDomain, String>map(_domains, _function);
                final String directionNames = IterableExtensions.join(_map, ", ");
                it.setStatic(true);
                final Procedure1<ITreeAppendable> _function_1 = new Procedure1<ITreeAppendable>() {
                  public void apply(final ITreeAppendable it) {
                    StringConcatenation _builder = new StringConcatenation();
                    _builder.append("java.util.Arrays.asList(");
                    _builder.append(directionNames, "");
                    _builder.append(")");
                    it.append(_builder);
                  }
                };
                JQVTJvmModelInferrer.this._jvmTypesBuilder.setInitializer(it, _function_1);
              }
            };
            final JvmField directionField = this._jvmTypesBuilder.toField(_eNull_2, _plus_2, typeStringArray, _function_4);
            this._jvmVisibilityExtension.makePublic(directionField);
            EList<JvmMember> _members_4 = trafoType.getMembers();
            this._jvmTypesBuilder.<JvmField>operator_add(_members_4, directionField);
          }
          boolean _isTopRelation_2 = relation_2.isTopRelation();
          boolean _not = (!_isTopRelation_2);
          if (_not) {
            EList<JvmMember> _members_5 = trafoType.getMembers();
            EObject _eNull_3 = this.eNull();
            String _name_4 = relation_2.getName();
            String _plus_3 = ("relation_" + _name_4);
            ...
            JvmOperation _method_3 = this._jvmTypesBuilder.toMethod(_eNull_3, _plus_3, relationType, _function_5);
    ...
    final Procedure1<JvmField> _function_3 = new Procedure1<JvmField>() {
      public void apply(final JvmField it) {
        it.setStatic(true);
        EList<Direction> _directions = transformation.getDirections();
        final Function1<Direction,String> _function = new Function1<Direction,String>() {
          public String apply(final Direction e) {
        ...
        List<String> _map = ListExtensions.<Direction, String>map(_directions, _function);
        final String directionNames = IterableExtensions.join(_map, ", ");
        final Procedure1<ITreeAppendable> _function_1 = new Procedure1<ITreeAppendable>() {
          public void apply(final ITreeAppendable it) {
            StringConcatenation _builder = new StringConcatenation();
    ...
    final JvmField globalDirectionField = this._jvmTypesBuilder.toField(_eNull, "global_direction", typeStringArray, _function_3);
    this._jvmVisibilityExtension.makePublic(globalDirectionField);
    EList<JvmMember> _members_2 = trafoType.getMembers();
    this._jvmTypesBuilder.<JvmField>operator_add(_members_2, globalDirectionField);
    final String _topFieldName = "topOrder";
    final String _topMethodName = "getTopSortedMethods";
    final Iterable<Relation> topSortedRelations = this._topRelationSorter.getTopSortedTopRelations(transformation);
    final Function1<Relation,String> _function_4 = new Function1<Relation,String>() {
      public String apply(final Relation r) {
        String _name = r.getName();
        return _name;
      }
    };
    Iterable<String> _map = IterableExtensions.<Relation, String>map(topSortedRelations, _function_4);
    String _join = IterableExtensions.join(_map, ", ");
    System.out.println(_join);
    final Function1<Relation,String> _function_5 = new Function1<Relation,String>() {
      public String apply(final Relation r) {
        String _xifexpression = null;
        if ((r instanceof FakeRelation)) {
          String _forceBreakCircleToString = JQVTJvmModelInferrer.this._topRelationSorter.forceBreakCircleToString(((FakeRelation) r), transformation);
          _xifexpression = _forceBreakCircleToString;
        } else {
          String _name = r.getName();
          String _plus = ("\"" + _name);
          String _plus_1 = (_plus + "\"");
    ...
    Iterable<String> _map_1 = IterableExtensions.<Relation, String>map(topSortedRelations, _function_5);
    final String topRelationString = IterableExtensions.join(_map_1, ", ");
    EObject _eNull_1 = this.eNull();
      ...
      public void apply(final JvmField it) {
        final Procedure1<ITreeAppendable> _function = new Procedure1<ITreeAppendable>() {
          public void apply(final ITreeAppendable it) {
            StringConcatenation _builder = new StringConcatenation();
            _builder.append("java.util.Arrays.asList( ");
            _builder.append(topRelationString, "");
            _builder.append(" )");
            it.append(_builder);
          }
        };
        JQVTJvmModelInferrer.this._jvmTypesBuilder.setInitializer(it, _function);
      }
    };
    final JvmField orderField = this._jvmTypesBuilder.toField(_eNull_1, _topFieldName, typeStringArray, _function_6);
    this._jvmVisibilityExtension.makePublic(orderField);
    EList<JvmMember> _members_3 = trafoType.getMembers();
    this._jvmTypesBuilder.<JvmField>operator_add(_members_3, orderField);
    JvmTypeReference _newTypeRef_2 = this._jvmTypesBuilder.newTypeRef(transformation, "java.lang.reflect.Method");
    final JvmTypeReference typeMethodList = this._jvmTypesBuilder.newTypeRef(transformation, "java.util.List", _newTypeRef_2);
    final String _cachedMethods = "cachedTopMethods";
    EObject _eNull_2 = this.eNull();
    ...
    final JvmField cachedTopSortedMethod = this._jvmTypesBuilder.toField(_eNull_2, _cachedMethods, typeMethodList, _function_7);
    EList<JvmMember> _members_4 = trafoType.getMembers();
    this._jvmTypesBuilder.<JvmField>operator_add(_members_4, cachedTopSortedMethod);
    EList<JvmMember> _members_5 = trafoType.getMembers();
    EObject _eNull_3 = this.eNull();
      ...
      public void apply(final JvmOperation it) {
        final Procedure1<ITreeAppendable> _function = new Procedure1<ITreeAppendable>() {
          public void apply(final ITreeAppendable it) {
            StringConcatenation _builder = new StringConcatenation();
            _builder.append("if(");
            _builder.append(_cachedMethods, "");
            _builder.append("!=null)");
            _builder.newLineIfNotEmpty();
            _builder.append("\t");
            ...
            _builder.newLineIfNotEmpty();
            _builder.append(_cachedMethods, "");
            _builder.append(" = new java.util.ArrayList<Method>();");
            _builder.newLineIfNotEmpty();
            _builder.append("Class clazz = this.getClass();");
            _builder.newLine();
            _builder.append("for(String it : this.");
            _builder.append(_topFieldName, "");
            _builder.append("){");
            _builder.newLineIfNotEmpty();
            _builder.append("\t");
            _builder.append("if(it.startsWith(\"[\"))");
            _builder.newLine();
            _builder.append("\t\t");
            _builder.append("System.err.println(\"The following relations are not evaluated due to circles: \"+it);");
            _builder.newLine();
            _builder.append("\t");
            _builder.append("for(Method m : clazz.getMethods()){");
            _builder.newLine();
            _builder.append("\t\t");
            _builder.append("if((\"top_relation_\" + it).equals(m.getName())){");
            _builder.newLine();
            _builder.append("\t\t\t");
            _builder.append(_cachedMethods, "			");
            _builder.append(".add(m);");
            _builder.newLineIfNotEmpty();
            _builder.append("\t\t\t");
    ...
    JvmOperation _method_2 = this._jvmTypesBuilder.toMethod(_eNull_3, _topMethodName, typeMethodList, _function_8);
    ...
    EList<JvmMember> _members_6 = trafoType.getMembers();
    ...
    JvmOperation _method_3 = this._jvmTypesBuilder.toMethod(_eNull_4, "create", returnT, _function_9);
    this._jvmTypesBuilder.<JvmOperation>operator_add(_members_6, _method_3);
    JvmTypeReference _newTypeRef_3 = this._jvmTypesBuilder.newTypeRef(transformation, "java.lang.Object");
    JvmTypeReference _newTypeRef_4 = this._jvmTypesBuilder.newTypeRef(transformation, "java.lang.Object");
    JvmTypeReference _newTypeRef_5 = this._jvmTypesBuilder.newTypeRef(transformation, "java.util.Set", _newTypeRef_4);
    final JvmTypeReference typeMapRel2SetRel = this._jvmTypesBuilder.newTypeRef(transformation, "java.util.Map", _newTypeRef_3, _newTypeRef_5);
    JvmTypeReference _newTypeRef_6 = this._jvmTypesBuilder.newTypeRef(transformation, Object.class);
    final JvmTypeReference typeStackRel = this._jvmTypesBuilder.newTypeRef(transformation, "java.util.Stack", _newTypeRef_6);
    EObject _eNull_5 = this.eNull();
    final Procedure1<JvmField> _function_10 = new Procedure1<JvmField>() {
      public void apply(final JvmField it) {
        final Procedure1<ITreeAppendable> _function = new Procedure1<ITreeAppendable>() {
          public void apply(final ITreeAppendable it) {
            StringConcatenation _builder = new StringConcatenation();
            _builder.append("new HashMap<Object,Set<Object>>()");
            it.append(_builder);
          }
        };
        JQVTJvmModelInferrer.this._jvmTypesBuilder.setInitializer(it, _function);
    ...
    final JvmField waitingList = this._jvmTypesBuilder.toField(_eNull_5, "waitingList", typeMapRel2SetRel, _function_10);
    this._jvmVisibilityExtension.makePublic(waitingList);
    EList<JvmMember> _members_7 = trafoType.getMembers();
    this._jvmTypesBuilder.<JvmField>operator_add(_members_7, waitingList);
    EObject _eNull_6 = this.eNull();
    final Procedure1<JvmField> _function_11 = new Procedure1<JvmField>() {
      public void apply(final JvmField it) {
        final Procedure1<ITreeAppendable> _function = new Procedure1<ITreeAppendable>() {
          public void apply(final ITreeAppendable it) {
            StringConcatenation _builder = new StringConcatenation();
            _builder.append("new Stack<Object>()");
            it.append(_builder);
          }
        };
        JQVTJvmModelInferrer.this._jvmTypesBuilder.setInitializer(it, _function);
    ...
    final JvmField relStack = this._jvmTypesBuilder.toField(_eNull_6, "relStack", typeStackRel, _function_11);
    this._jvmVisibilityExtension.makePublic(relStack);
    EList<JvmMember> _members_8 = trafoType.getMembers();
    this._jvmTypesBuilder.<JvmField>operator_add(_members_8, relStack);
    JvmTypeReference _newTypeRef_7 = this._jvmTypesBuilder.newTypeRef(transformation, "java.lang.Integer");
    JvmTypeReference _newTypeRef_8 = this._jvmTypesBuilder.newTypeRef(transformation, "java.lang.Integer");
    final JvmTypeReference logClausesMap = this._jvmTypesBuilder.newTypeRef(transformation, "java.util.Map", _newTypeRef_7, _newTypeRef_8);
    EObject _eNull_7 = this.eNull();
    ...
    final JvmField successMap = this._jvmTypesBuilder.toField(_eNull_7, "successes", logClausesMap, _function_12);
    this._jvmVisibilityExtension.makePublic(successMap);
    EList<JvmMember> _members_9 = trafoType.getMembers();
    this._jvmTypesBuilder.<JvmField>operator_add(_members_9, successMap);
    EObject _eNull_8 = this.eNull();
    ...
    final JvmField failureMap = this._jvmTypesBuilder.toField(_eNull_8, "failures", logClausesMap, _function_13);
    this._jvmVisibilityExtension.makePublic(failureMap);
    EList<JvmMember> _members_10 = trafoType.getMembers();
    this._jvmTypesBuilder.<JvmField>operator_add(_members_10, failureMap);
    EList<JvmMember> _members_11 = trafoType.getMembers();
    EObject _eNull_9 = this.eNull();
    JvmTypeReference _newTypeRef_9 = this._jvmTypesBuilder.newTypeRef(transformation, void.class);
    final Procedure1<JvmOperation> _function_14 = new Procedure1<JvmOperation>() {
      public void apply(final JvmOperation it) {
        EList<JvmFormalParameter> _parameters = it.getParameters();
        EObject _eNull = JQVTJvmModelInferrer.this.eNull();
        JvmTypeReference _newTypeRef = JQVTJvmModelInferrer.this._jvmTypesBuilder.newTypeRef(transformation, int.class);
        JvmFormalParameter _parameter = JQVTJvmModelInferrer.this._jvmTypesBuilder.toParameter(_eNull, "i", _newTypeRef);
        JQVTJvmModelInferrer.this._jvmTypesBuilder.<JvmFormalParameter>operator_add(_parameters, _parameter);
        final Procedure1<ITreeAppendable> _function = new Procedure1<ITreeAppendable>() {
          public void apply(final ITreeAppendable it) {
            StringConcatenation _builder = new StringConcatenation();
            _builder.append("Integer prev = successes.get(i);");
            _builder.newLine();
            _builder.append("successes.put(i, prev == null ? 1 : prev+1);");
            it.append(_builder);
          }
        };
        JQVTJvmModelInferrer.this._jvmTypesBuilder.setBody(it, _function);
    ...
    JvmOperation _method_4 = this._jvmTypesBuilder.toMethod(_eNull_9, "logSuccess", _newTypeRef_9, _function_14);
    this._jvmTypesBuilder.<JvmOperation>operator_add(_members_11, _method_4);
    EList<JvmMember> _members_12 = trafoType.getMembers();
    EObject _eNull_10 = this.eNull();
    JvmTypeReference _newTypeRef_10 = this._jvmTypesBuilder.newTypeRef(transformation, void.class);
    final Procedure1<JvmOperation> _function_15 = new Procedure1<JvmOperation>() {
      public void apply(final JvmOperation it) {
        ...
        final Procedure1<ITreeAppendable> _function = new Procedure1<ITreeAppendable>() {
          public void apply(final ITreeAppendable it) {
            StringConcatenation _builder = new StringConcatenation();
            _builder.append("Integer prev = failures.get(i);");
            _builder.newLine();
            _builder.append("failures.put(i, prev == null ? 1 : prev+1);");
            it.append(_builder);
          }
        };
        JQVTJvmModelInferrer.this._jvmTypesBuilder.setBody(it, _function);
    ...
    JvmOperation _method_5 = this._jvmTypesBuilder.toMethod(_eNull_10, "logFailure", _newTypeRef_10, _function_15);
