...
entryRuleQualifiedNameWithWildCard2 returns [String current=null] 
	:
	{ newCompositeNode(grammarAccess.getQualifiedNameWithWildCard2Rule()); } 
	 ...
	 { $current=$iv_ruleQualifiedNameWithWildCard2.current.getText(); }  
	 EOF 
;

// Rule QualifiedNameWithWildCard2
ruleQualifiedNameWithWildCard2 returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(
...
(
(
		lv_transformationName_1_0=RULE_ID
		{
...
entryRuleRelationDomain returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getRelationDomainRule()); }
	 iv_ruleRelationDomain=ruleRelationDomain 
	 { $current=$iv_ruleRelationDomain.current; } 
	 EOF 
;

// Rule RelationDomain
ruleRelationDomain returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='enforce' 
...
entryRulePropertyTemplateItem returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getPropertyTemplateItemRule()); }
	 iv_rulePropertyTemplateItem=rulePropertyTemplateItem 
	 { $current=$iv_rulePropertyTemplateItem.current; } 
	 EOF 
;

// Rule PropertyTemplateItem
rulePropertyTemplateItem returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
...
((((
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getQualifiedNameAccess().getFullStopKeyword_1_0_0_0()); 
    }
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getQualifiedNameAccess().getColonColonKeyword_1_0_0_1()); 
    }
))
    { 
