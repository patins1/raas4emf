...
public class JQVTSemanticSequencer extends XbaseSemanticSequencer {
	...
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == JQVTPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			...
			case JQVTPackage.OBJECT_TEMPLATE:
				if(context == grammarAccess.getObjectTemplateRule()) {
			...
			case JQVTPackage.PROPERTY_TEMPLATE_ITEM:
				if(context == grammarAccess.getPropertyTemplateItemRule()) {
			...
			case JQVTPackage.RELATION_DOMAIN:
				if(context == grammarAccess.getRelationDomainRule()) {
			...
			case XbasePackage.XVARIABLE_DECLARATION:
				...
				else if(context == grammarAccess.getXExpressionInsideBlockRule() ||
	...
	protected void sequence_Import(EObject context, Import semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, JQVTPackage.Literals.IMPORT__IMPORTED_NAMESPACE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, JQVTPackage.Literals.IMPORT__IMPORTED_NAMESPACE));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
	 ...
	 */
	protected void sequence_ObjectTemplate(EObject context, ObjectTemplate semanticObject) {
	...
	/**
	 * Constraint:
	 *     (name=QualifiedName imports+=Import* transformation=Transformation)
	 */
	 ...
	 */
	protected void sequence_PropertyTemplateItem(EObject context, PropertyTemplateItem semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 */
	protected void sequence_RelationDomain(EObject context, RelationDomain semanticObject) {
		if(errorAcceptor != null) {
	 ...
	 */
	protected void sequence_VarDecl(EObject context, XVariableDeclaration semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
}
